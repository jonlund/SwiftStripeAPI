...
public struct GetAccounts: StripeAPIEndpoint {
	...
	public final class Output: Codable {
		...
		public init(data: [Account], has_more: Bool, object: ObjectValues, url: String) {
			self.data = data
...
/// With <a href="/docs/connect">Connect</a>, you can create Stripe accounts for your users. To do this, you’ll first need to <a href="https://dashboard.stripe.com/account/applications/settings">register your platform</a>.
public struct PostAccounts: StripeAPIEndpoint {
	...
	public final class FormInput: Codable {
		...
		public init(account_token: String? = nil, bank_account: AnyCodable? = nil, business_profile: BusinessProfileSpecs? = nil, business_type: BusinessTypeValues? = nil, capabilities: CapabilitiesParam? = nil, company: CompanySpecs? = nil, country: String? = nil, default_currency: String? = nil, documents: DocumentsSpecs? = nil, email: String? = nil, expand: [String]? = nil, external_account: String? = nil, individual: IndividualSpecs? = nil, metadata: AnyCodable? = nil, settings: SettingsSpecs? = nil, tos_acceptance: TosAcceptanceSpecs? = nil, type: TypeValues? = nil) {
...
public struct PostAccountsAccount: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = Account
	public typealias paramType = Params
...
public struct PostAccountsAccountBankAccounts: StripeAPIEndpoint {
	public typealias inputType = FormInput
...
public struct PostAccountsAccountBankAccountsId: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = ExternalAccount
	public typealias paramType = Params
...
public struct PostAccountsAccountCapabilitiesCapability: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = Capability
	public typealias paramType = Params
...
public struct GetAccountsAccountExternalAccounts: StripeAPIEndpoint {
	...
	public struct Params {
		...
		/// - Parameter limit: A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
		/// - Parameter starting_after: A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
		public init(account: String, ending_before: String? = nil, limit: Int? = nil, starting_after: String? = nil) {
			self.account = account
			self.ending_before = ending_before
			self.limit = limit
			self.starting_after = starting_after
	...
	public static func endpoint(for inputs: Params) throws -> String {
		...
		if let a = inputs.starting_after?.urlEncoded { params.append("starting_after=\(a)") }
		let query = params.joined(separator: "&")
		return "/v1/accounts/\(inputs.account)/external_accounts?\(query)"
	}
	public static var method: HTTPMethod { return .GET }
...
/// Create an external account for a given account.
public struct PostAccountsAccountExternalAccounts: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = ExternalAccount
	public typealias paramType = Params
...
/// Updates the metadata, account holder name, account holder type of a bank account belonging to a <a href="/docs/connect/custom-accounts">Custom account</a>, and optionally sets it as the default for its currency. Other bank account details are not editable by design.  You can re-enable a disabled bank account by performing an update call without providing any arguments or changes.
public struct PostAccountsAccountExternalAccountsId: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = ExternalAccount
	public typealias paramType = Params
...
public struct PostAccountsAccountLoginLinks: StripeAPIEndpoint {
	public typealias inputType = FormInput
	...
	public final class FormInput: Codable {
		...
		public init(expand: [String]? = nil, redirect_url: String? = nil) {
			self.expand = expand
...
public struct GetAccountsAccountPeople: StripeAPIEndpoint {
	...
	public static func endpoint(for inputs: Params) throws -> String {
		...
		if let a = inputs.starting_after?.urlEncoded { params.append("starting_after=\(a)") }
		let query = params.joined(separator: "&")
		return "/v1/accounts/\(inputs.account)/people?\(query)"
	}
	public static var method: HTTPMethod { return .GET }
...
public struct PostAccountsAccountPeople: StripeAPIEndpoint {
	public typealias inputType = FormInput
	...
	public final class FormInput: Codable {
		...
		public init(address: AddressSpecs? = nil, address_kana: JapanAddressKanaSpecs? = nil, address_kanji: JapanAddressKanjiSpecs? = nil, dob: AnyCodable? = nil, documents: PersonDocumentsSpecs? = nil, email: String? = nil, expand: [String]? = nil, first_name: String? = nil, first_name_kana: String? = nil, first_name_kanji: String? = nil, full_name_aliases: [String]? = nil, gender: String? = nil, id_number: String? = nil, last_name: String? = nil, last_name_kana: String? = nil, last_name_kanji: String? = nil, maiden_name: String? = nil, metadata: AnyCodable? = nil, nationality: String? = nil, person_token: String? = nil, phone: String? = nil, political_exposure: String? = nil, relationship: RelationshipSpecs? = nil, ssn_last_4: String? = nil, verification: PersonVerificationSpecs? = nil) {
			self.address = address
			self.address_kana = address_kana
			self.address_kanji = address_kanji
			self.dob = dob
...
public struct PostAccountsAccountPeoplePerson: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = Person
	public typealias paramType = Params
...
public struct GetAccountsAccountPersons: StripeAPIEndpoint {
	...
	public static func endpoint(for inputs: Params) throws -> String {
		...
		if let a = inputs.starting_after?.urlEncoded { params.append("starting_after=\(a)") }
		let query = params.joined(separator: "&")
		return "/v1/accounts/\(inputs.account)/persons?\(query)"
	}
	public static var method: HTTPMethod { return .GET }
...
/// Creates a new person.
public struct PostAccountsAccountPersons: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = Person
	public typealias paramType = Params
...
/// Updates an existing person.
public struct PostAccountsAccountPersonsPerson: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = Person
	public typealias paramType = Params
...
/// With <a href="/docs/connect">Connect</a>, you may flag accounts as suspicious.  Test-mode Custom and Express accounts can be rejected at any time. Accounts created using live-mode keys may only be rejected once all balances are zero.
public struct PostAccountsAccountReject: StripeAPIEndpoint {
	public typealias inputType = FormInput
	public typealias outputType = Account
	public typealias paramType = Params
