...
public struct GetIssuerFraudRecords: StripeAPIEndpoint {
	...
	public static func endpoint(for inputs: Params) throws -> String {
		return "/v1/issuer_fraud_records?ending_before=\(inputs.ending_before.urlEncoded))&starting_after=\(inputs.starting_after.urlEncoded))&limit=\(inputs.limit.urlEncoded))&charge=\(inputs.charge.urlEncoded))"
	}
