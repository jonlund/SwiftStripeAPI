...
public struct GetWebhookEndpoints: StripeAPIEndpoint {
	...
	public static func endpoint(for inputs: Params) throws -> String {
		return "/v1/webhook_endpoints?ending_before=\(inputs.ending_before.urlEncoded))&starting_after=\(inputs.starting_after.urlEncoded))&limit=\(inputs.limit.urlEncoded))"
	}
...
public struct PostWebhookEndpoints: StripeAPIEndpoint {
	...
	public class FormInput: Codable {
		...
		public init(enabled_events: [String], url: String, api_version: ApiVersionValues? = nil, connect: Bool? = nil, description: String? = nil, expand: [String]? = nil, metadata: MESSED_UP? = nil) {
...
public struct PostWebhookEndpointsWebhookEndpoint: StripeAPIEndpoint {
	...
	public class FormInput: Codable {
		...
		public init(description: String? = nil, disabled: Bool? = nil, enabled_events: [String]? = nil, expand: [String]? = nil, metadata: MESSED_UP? = nil, url: String? = nil) {
			self.description = description
