...
public struct GetOrders: StripeAPIEndpoint {
	...
	public static func endpoint(for inputs: Params) throws -> String {
		return "/v1/orders?ending_before=\(inputs.ending_before.urlEncoded))&status=\(inputs.status.urlEncoded))&customer=\(inputs.customer.urlEncoded))&limit=\(inputs.limit.urlEncoded))&starting_after=\(inputs.starting_after.urlEncoded))"
	}
...
public struct PostOrders: StripeAPIEndpoint {
	...
	public class FormInput: Codable {
		...
		public init(currency: String, coupon: String? = nil, customer: String? = nil, email: String? = nil, expand: [String]? = nil, items: MESSED_UP? = nil, metadata: String? = nil, shipping: CustomerShipping? = nil) {
...
public struct PostOrdersIdPay: StripeAPIEndpoint {
	...
	public class FormInput: Codable {
		...
		public init(application_fee: Int? = nil, customer: String? = nil, email: String? = nil, expand: [String]? = nil, metadata: String? = nil, source: String? = nil) {
