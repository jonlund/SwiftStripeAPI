...
public struct PostAccounts: StripeAPIEndpoint {
	...
	public final class FormInput: Codable {
		...
		public init(account_token: String? = nil, bank_account: MESSED_UP? = nil, business_profile: BusinessProfileSpecs? = nil, business_type: BusinessTypeValues? = nil, capabilities: CapabilitiesParam? = nil, company: CompanySpecs? = nil, country: String? = nil, default_currency: String? = nil, documents: DocumentsSpecs? = nil, email: String? = nil, expand: [String]? = nil, external_account: String? = nil, individual: IndividualSpecs? = nil, metadata: MESSED_UP? = nil, settings: SettingsSpecs? = nil, tos_acceptance: TosAcceptanceSpecs? = nil, type: TypeValues? = nil) {
...
public struct PostAccountsAccountPeople: StripeAPIEndpoint {
	...
	public final class FormInput: Codable {
		...
		public init(address: AddressSpecs? = nil, address_kana: JapanAddressKanaSpecs? = nil, address_kanji: JapanAddressKanjiSpecs? = nil, dob: MESSED_UP? = nil, email: String? = nil, expand: [String]? = nil, first_name: String? = nil, first_name_kana: String? = nil, first_name_kanji: String? = nil, gender: String? = nil, id_number: String? = nil, last_name: String? = nil, last_name_kana: String? = nil, last_name_kanji: String? = nil, maiden_name: String? = nil, metadata: MESSED_UP? = nil, person_token: String? = nil, phone: String? = nil, political_exposure: String? = nil, relationship: RelationshipSpecs? = nil, ssn_last_4: String? = nil, verification: PersonVerificationSpecs? = nil) {
			self.address = address
			self.address_kana = address_kana
			self.address_kanji = address_kanji
			self.dob = dob
